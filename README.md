...
### Prerequisites
Before proceeding:
* Install [Webots](https://cyberbotics.com) following the [official guide](https://cyberbotics.com/doc/guide/installing-webots).
...
* Edit the `local path` in [utils.py](./utils.py) so that it points to the cloned repository.

That's all, everything is installed and you can run the NAO-ISL robot!

### Run
Run the project is easy 
